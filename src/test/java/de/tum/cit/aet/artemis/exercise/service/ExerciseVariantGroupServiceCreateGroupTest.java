...
class ExerciseVariantGroupServiceCreateGroupTest {
    ...
    void setUp() {
        ...
        service = new ExerciseVariantGroupService(exerciseVariantGroupRepository, mock(ExerciseTestRepository.class), courseRepository,
                ...
                mock(InstanceMessageSendService.class), mock(QuizExerciseService.class), mock(UserStoryExerciseService.class), Optional.<SlideApi>empty(),
                mock(MilestoneExerciseGroupRepository.class), mock(MilestoneExercisePointsService.class));
