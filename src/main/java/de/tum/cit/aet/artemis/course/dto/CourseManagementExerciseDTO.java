...
@JsonSubTypes({ @JsonSubTypes.Type(value = ProgrammingExerciseResponseDTO.class, names = { "programming", "milestone", "user-story" }),
        @JsonSubTypes.Type(value = TextExerciseResponseDTO.class, name = "text"), @JsonSubTypes.Type(value = ModelingExerciseResponseDTO.class, name = "modeling"),
        @JsonSubTypes.Type(value = FileUploadExerciseDTO.class, name = "file-upload"), @JsonSubTypes.Type(value = CourseManagementQuizExerciseDTO.class, name = "quiz") })
