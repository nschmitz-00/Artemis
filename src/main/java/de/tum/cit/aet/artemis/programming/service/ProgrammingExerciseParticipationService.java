...
public class ProgrammingExerciseParticipationService {
    ...
    public Optional<ProgrammingExerciseParticipation> getParticipationReferenceForRepository(String repositoryTypeOrUserName, String repositoryUri, String projectKey) {
        ...
        if (repositoryTypeOrUserName.equals(RepositoryType.TEMPLATE.toString())) {
            return templateParticipationRepository.findIdByRepositoryUriAndProjectKey(repositoryUriWithoutService, projectKey)
                    .map(templateParticipationRepository::getReferenceById);
        }
        return studentParticipationRepository.findIdByRepositoryUriAndProjectKey(repositoryUriWithoutService, projectKey).map(studentParticipationRepository::getReferenceById);
    }
