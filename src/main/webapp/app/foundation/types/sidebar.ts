...
export interface SidebarCardElement {
    ...
    /**
     * Renders {@link groupedItems} as cards of their own, listed under this card. Set for milestone groups only: their
     * user stories are separate pieces of work on a shared repository, not interchangeable variants a student picks from.
     */
    renderGroupedItems?: boolean;
