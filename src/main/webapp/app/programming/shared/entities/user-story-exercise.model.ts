 ...
 * problem statement, but inherits all dates and repositories from its parent Milestone. It extends ProgrammingExercise
...
export class UserStoryExercise extends ProgrammingExercise {
    /**
     * The parent MilestoneExercise this UserStory belongs to. All dates and repositories are inherited from it.
     */
