...
describe('SidebarAccordionComponent', () => {
    ...
    describe('a milestone group', () => {
        // A milestone's user stories are separate pieces of work rather than variants, so they are listed under its card.
        beforeEach(() => {
            fixture.componentRef.setInput('groupedData', {
                current: {
                    entityData: [
                        {
                            ...
                            groupedItems: [
                                { title: 'Login form', id: 11, size: 'M', type: 'user-story' },
                                { title: 'Logout', id: 12, size: 'M', type: 'user-story' },
                            ],
                        },
                    ],
                },
