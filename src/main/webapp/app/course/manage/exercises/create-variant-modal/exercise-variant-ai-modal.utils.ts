 ...
 * Milestone and user story exercises carry their own type and fall through to `false`: they only work inside their
 * milestone group, whose repositories and test cases a standalone clone would not have.
 */
