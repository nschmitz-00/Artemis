...
describe('supportsAiVariantGeneration', () => {
    ...
    // Milestones and user stories only work inside their milestone group, so a standalone clone would be broken.
    it.each([ExerciseType.TEXT, ExerciseType.MODELING, ExerciseType.FILE_UPLOAD, ExerciseType.MILESTONE, ExerciseType.USER_STORY])('should not support %s exercises', (type) => {
