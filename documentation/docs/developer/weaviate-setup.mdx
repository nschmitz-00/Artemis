...
| t2v-transformers | 8081  | Embedding model (internal, not exposed)  |
...
| `TRANSFORMERS_INFERENCE_API`              | http://t2v-transformers:8081                      | URL of the transformer inference service (embeddings only)                        |
