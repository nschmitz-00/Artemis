...
- **Artemis (Server & Client):** Will start the server and the client. The client will be available at [http://localhost:8081/](http://localhost:8081/) with hot module replacement disabled.
